...
void informarSobrePelicula(ePelicula listaPeliculas[],int tam,eActor listaActores[],int tamAct)
{
    ...
    getInt("1.Listar los datos de Peliculas sin actores\
           ...
           \n12.Listar actores por edades de mayor a menor\
           \n13.Listar actores mayores de edad\
           \n14.Salir\nQue desea hacer?\n\n",&opcion,1,14);
    ...
    switch(opcion)
    {
        ...
        case 12:
            ...
            listarActoresEdadMayorAmenor(listaActores,tamAct);
            break;
        case 13:

            listaActoresMayoresDeEdad(listaActores,tamAct);
            break;
    }
